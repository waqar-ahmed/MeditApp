...
public class PPGSingleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        graph.getGridLabelRenderer().setLabelFormatter(new DateAsXAxisLabelFormatter(PPGSingleActivity.this, simpleDateFormat));
            ...
            public void run() {
                ...
                client.get("http://" + serverIP + ":8086/query", params, new JsonHttpResponseHandler(){
                    ...
                    public void onFailure(int statusCode, Header[] headers, Throwable t, JSONObject response) {
                        // called when response HTTP status is "200 OK"
                        Log.d("Throable", "" + t);
                        Toast.makeText(PPGSingleActivity.this, "Error retreiving data. Make sure you are connected to internet.", Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void processJson(JSONObject response) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(PPGSingleActivity.this, e.getMessage() + ". Make sure the device and database is running.", Toast.LENGTH_SHORT).show();
        }
        if(points != null){
