...
public class CustomPointsGraphSeries<E extends CustomDataPointInterface> extends BaseSeries<E> {
    /**
    ...
    public static interface CustomShape {
         ...
         */
        void draw(Canvas canvas, Paint paint, float x, float y, CustomDataPointInterface dataPoint);
    }
     ...
     */
    public CustomPointsGraphSeries() {
        init();
    }
     ...
     */
    public CustomPointsGraphSeries(E[] data) {
        super(data);
        init();
    }
